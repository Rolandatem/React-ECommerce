...
const HomeCarousel = () => {
    return (
        <Carousel fade>
            <Carousel.Item>
                <Image src='carousel-mobile/oak-floor.jpg' fluid className="d-sm-none w-100" />
                <Image src='carousel/oak-floor.jpg' fluid className="d-none d-sm-block w-100" />
                <Carousel.Caption>
                    <Card className={`bg-white text-dark ${styles.cardOpacity}`}>
                        <Card.Body>
                            <h3 className="d-none d-sm-block">Hardwood Floors</h3>
            ...
            <Carousel.Item>
                <Image src='carousel-mobile/slider-showroom.jpg' fluid className="d-sm-none w-100" />
                <Image src='carousel/slider-showroom.jpg' fluid className="d-none d-sm-block w-100" />
                <Carousel.Caption>
                    <Card className={`bg-white text-dark ${styles.cardOpacity}`}>
                        <Card.Body>
                            <h3 className="d-none d-sm-block">Wide Range of Flooring Options</h3>
                            <p className="d-sm-none">
            ...
            <Carousel.Item>
                <Image src='carousel-mobile/white-oak.jpg' fluid className="d-sm-none w-100" />
                <Image src='carousel/white-oak.jpg' fluid className="d-none d-sm-block w-100" />
                <Carousel.Caption>
                    <Card className={`bg-white text-dark ${styles.cardOpacity}`}>
                        <Card.Body>
                            <h3 className="d-none d-sm-block">Vinyl Flooring</h3>
                            <p className="d-sm-none">
